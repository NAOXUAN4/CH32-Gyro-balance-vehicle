...
#define LCD_DC_Clr()   GPIO_ResetBits(GPIOD,GPIO_Pin_7)//DC
#define LCD_DC_Set()   GPIO_SetBits(GPIOD,GPIO_Pin_7)
 		     
#define LCD_CS_Clr()   GPIO_ResetBits(GPIOD,GPIO_Pin_4)//CS
#define LCD_CS_Set()   GPIO_SetBits(GPIOD,GPIO_Pin_4)

#define LCD_BLK_Clr()  GPIO_ResetBits(GPIOD,GPIO_Pin_0)//BLK
#define LCD_BLK_Set()  GPIO_SetBits(GPIOD,GPIO_Pin_0)
